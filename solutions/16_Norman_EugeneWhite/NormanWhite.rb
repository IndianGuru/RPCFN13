STDOUT.sync = true  # added chomp for Widows by ashbb
=begin **************************************************************************
	...
	if myWord == pattern then		
		...
		case
			...
			when action==7	#Process the country's inflation rate************************************
				...
				highestInflationRate << [inflationRate.to_f,countryName]
				collectedWord=""
				collectSwitch=0
				if traceOn == 1
